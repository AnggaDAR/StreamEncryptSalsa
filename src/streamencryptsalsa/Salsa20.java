...
public class Salsa20 {
    ...
    public Salsa20(String k, String iv, int msgLength) {
...
//                }
 ...
 /* Fungsi enkripsi salsa20/20 pada nilai RGB */
        ...
        ImageIO.write(image, "jpg", bo);//penyimpanan gambar hasil enkripsi
        bo.close();
    }
...
//        }
        ...
        bo = new BufferedOutputStream(fo);
        ImageIO.write(image, "jpg", bo);//penyimpanan gambar hasil dekripsi
        bo.close();
    }
